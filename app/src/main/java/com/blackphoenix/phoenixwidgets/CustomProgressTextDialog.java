...
public class CustomProgressTextDialog extends AlertDialog {
    ...
    public CustomProgressTextDialog(Context context, int themeResId, String text) {
    ...
    public CustomProgressTextDialog(Context context, int themeResId, String text, long timeout /* TIMEOUT in Milliseconds*/) {
        super(context, themeResId);
        this.progressText = text;
